      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-6">
            ...
            <span className="text-sm font-medium text-accent">Loved by Thousands</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join thousands of satisfied parents and institutions who have transformed
            their educational experience with Zora.
          </p>
        </motion.div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {testimonial.role}
                    {testimonial.institution && ` at ${testimonial.institution}`}
                  </div>
                </div>
                {testimonial.isB2B && (
